 ...
 *
 * @param   $user_id    int Id проверяемого.
 *
...
function vrfd_after_title() {
	...
	$div = '.office-title > h2,.cab_ln_title > h2,.office-content-top > h2,.ao_name_author_lk > h2,.cab_lt_title > h2, .cab_title > h2,.webx-user-name';
